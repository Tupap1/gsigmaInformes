...
CREATE TABLE IF NOT EXISTS `proveedo` (
  ...
  `PUCCOD` varchar(15) NOT NULL DEFAULT '',
  `PROPLAENT` double NOT NULL DEFAULT '0',
  `PROEMA` varchar(50) DEFAULT '',
  `PROWEB` varchar(50) NOT NULL DEFAULT '',
  `PROPAG` varchar(100) NOT NULL DEFAULT '',
  `PRONUMDOC` varchar(15) NOT NULL,
  `PROTIPDOC` varchar(1) NOT NULL,
  `EMPID` varchar(20) NOT NULL DEFAULT '000000000000001',
  `PROIMPNO` bit(1) NOT NULL DEFAULT b'0',
  `PROTEL2` varchar(40) NOT NULL DEFAULT '',
  `PROTEL3` varchar(40) NOT NULL DEFAULT '',
  `PROFECMOD` date DEFAULT NULL,
  `PROSECMOD` double NOT NULL DEFAULT '0',
  `TABTIPNEG` varchar(1) NOT NULL DEFAULT '',
