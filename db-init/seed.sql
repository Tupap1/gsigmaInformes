...
INSERT INTO `pv`.`compra` (EMPID, COMNUM, COMPRO, COMFEC) VALUES
('000000000000001', 'COM-2026-001', '900120000000001', '2026-07-10');
INSERT INTO `pv`.`dcmpr` (DCMNUM, DCMART, DCMCAN, DCMCOS) VALUES
('COM-2026-001', '001', 10.0000, 50000.00);

-- Compra histórica (2024)
INSERT INTO `pv`.`compra24` (EMPID, COMNUM, COMPRO, COMFEC) VALUES
('000000000000001', 'COM-2024-001', '900120000000001', '2024-05-15');
